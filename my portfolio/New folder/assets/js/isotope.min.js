    ...
    function(t) {
        ...
        function n(t, n, r) {
            ...
            a.prototype.ontransitionend = function(t) { if (t.target === this.element) { var e = this._transn,
                    ...
                    this.emitEvent("transitionEnd", [this]) } }, a.prototype.disableTransition = function() { this.removeTransitionStyles(), this.element.removeEventListener(c, this, !1), this.isTransitioning = !1 }, a.prototype._removeStyles = function(t) { var e = {}; for (var i in t) e[i] = "";
